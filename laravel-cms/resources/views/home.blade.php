                    ...
                    <div class="relative mx-auto max-w-2xl lg:mx-0">
                      ...
                      <figure>
                        ...
                        <figcaption class="mt-6 text-base text-white">
                          ...
                          <div class="mt-1">{{ $featured->category->name }}</div>
                        </figcaption>
                      </figure>
                    </div>
                  </div>
                    ...
                    @foreach ($latest as $article)
                      <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pb-8 pt-20">
                          ...
                          <h3 class="mt-3 font-semibold leading-6 text-white">
                            ...
                            <a href="#" class="relative z-10 rounded-full bg-gray-50 mx-8 px-3 py-1.5 font-medium text-gray-600 hover:bg-gray-100">{{ $article->category->name }}</a>
                          </h3>
                        </article>
                      @endforeach
                  </div>
