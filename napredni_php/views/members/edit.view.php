...
<main class="container my-3 d-flex flex-column flex-grow-1 vh-100">
    ...
    <form class="row g-3 mt-3" action="/members/update" method="POST">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="adresa" name="adresa" value="<?= $member['adresa'] ?>" required>
        </div>
        <div class="col-md-6">
            <label for="telefon" class="form-label">Telefon</label>
            <input type="text" class="form-control" id="telefon" name="telefon" value="<?= $member['telefon'] ?>" required>
        </div>
        <div class="col-md-6">
